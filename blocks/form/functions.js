...
import {
  getOTP, otpValidation, checkOffer, getThisCard, resendOTP, prefillForm,
...
export {
  getFullName, onWizardInit, getOTP, otpValidation, days, checkOffer, getThisCard, resendOTP, prefillForm,
};
